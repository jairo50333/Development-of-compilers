...
public enum Tokens {
    ...
    RPAREN=19,COLUMN=20,MOD=21,IF=22,THEN=23,ELSE=24,
    REPEAT=25,UNTIL=26,DO=27,INUM=28,RNUM=29,ID=30};
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      ...
      "write", "empty", "var", "varlist", "if", "repeat", "while", "stlist", 
      "$accept", "Anon@1", };
  ...
  static Parser() {
    ...
    states[4] = new State(new int[]{30,18,3,4,5,33,12,37,13,42,6,50,25,55,22,61,4,-14,11,-14},new int[]{-17,5,-6,59,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-16,49,-15,54,-14,60});
    states[5] = new State(new int[]{4,6,11,7});
    states[6] = new State(-27);
    states[7] = new State(new int[]{30,18,3,4,5,33,12,37,13,42,6,50,25,55,22,61,4,-14,11,-14,26,-14},new int[]{-6,8,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-16,49,-15,54,-14,60});
    states[8] = new State(-4);
    states[9] = new State(-5);
    states[10] = new State(new int[]{7,11});
    states[11] = new State(new int[]{30,18,28,19,18,20},new int[]{-2,12,-4,30,-5,29,-3,17});
    states[12] = new State(new int[]{14,13,15,23,4,-16,11,-16,26,-16,24,-16});
    states[13] = new State(new int[]{30,18,28,19,18,20},new int[]{-4,14,-5,29,-3,17});
    states[14] = new State(new int[]{16,15,17,25,21,27,14,-17,15,-17,4,-17,11,-17,26,-17,24,-17,19,-17,30,-17,3,-17,5,-17,12,-17,13,-17,6,-17,25,-17,22,-17,27,-17,23,-17});
    ...
    states[24] = new State(new int[]{16,15,17,25,21,27,14,-18,15,-18,4,-18,11,-18,26,-18,24,-18,19,-18,30,-18,3,-18,5,-18,12,-18,13,-18,6,-18,25,-18,22,-18,27,-18,23,-18});
    ...
    states[30] = new State(new int[]{16,15,17,25,21,27,14,-19,15,-19,4,-19,11,-19,26,-19,24,-19,19,-19,30,-19,3,-19,5,-19,12,-19,13,-19,6,-19,25,-19,22,-19,27,-19,23,-19});
    states[31] = new State(-6);
    states[32] = new State(-7);
    states[33] = new State(new int[]{30,18,28,19,18,20},new int[]{-2,34,-4,30,-5,29,-3,17});
    states[34] = new State(new int[]{14,13,15,23,30,18,3,4,5,33,12,37,13,42,6,50,25,55,22,61,4,-14,11,-14,26,-14,24,-14},new int[]{-6,35,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-16,49,-15,54,-14,60});
    ...
    states[39] = new State(new int[]{19,40,14,13,15,23});
    states[40] = new State(-30);
    states[41] = new State(-9);
    states[42] = new State(-31,new int[]{-19,43});
    states[43] = new State(new int[]{30,18},new int[]{-13,44,-3,47});
    states[44] = new State(new int[]{20,45,4,-32,11,-32,26,-32,24,-32});
    ...
    states[51] = new State(new int[]{27,52,14,13,15,23});
    states[52] = new State(new int[]{30,18,3,4,5,33,12,37,13,42,6,50,25,55,22,61,4,-14,11,-14,26,-14,24,-14},new int[]{-6,53,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-16,49,-15,54,-14,60});
    states[53] = new State(-29);
    states[54] = new State(-12);
    states[55] = new State(new int[]{30,18,3,4,5,33,12,37,13,42,6,50,25,55,22,61,26,-14,11,-14},new int[]{-17,56,-6,59,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-16,49,-15,54,-14,60});
    states[56] = new State(new int[]{26,57,11,7});
    states[57] = new State(new int[]{30,18,28,19,18,20},new int[]{-2,58,-4,30,-5,29,-3,17});
    states[58] = new State(new int[]{14,13,15,23,4,-35,11,-35,26,-35,24,-35});
    states[59] = new State(-3);
    states[60] = new State(-13);
    states[61] = new State(new int[]{30,18,28,19,18,20},new int[]{-2,62,-4,30,-5,29,-3,17});
    states[62] = new State(new int[]{23,63,14,13,15,23});
    states[63] = new State(new int[]{30,18,3,4,5,33,12,37,13,42,6,50,25,55,22,61,4,-14,11,-14,26,-14,24,-14},new int[]{-6,64,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-16,49,-15,54,-14,60});
    states[64] = new State(new int[]{24,65,4,-37,11,-37,26,-37});
    states[65] = new State(new int[]{30,18,3,4,5,33,12,37,13,42,6,50,25,55,22,61,4,-14,11,-14,26,-14,24,-14},new int[]{-6,66,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-16,49,-15,54,-14,60});
    states[66] = new State(-38);

    rules[1] = new Rule(-18, new int[]{-1,2});
    rules[2] = new Rule(-1, new int[]{-8});
    rules[3] = new Rule(-17, new int[]{-6});
    rules[4] = new Rule(-17, new int[]{-17,11,-6});
    ...
    rules[16] = new Rule(-7, new int[]{-3,7,-2});
    rules[17] = new Rule(-2, new int[]{-2,14,-4});
    rules[18] = new Rule(-2, new int[]{-2,15,-4});
    ...
    rules[29] = new Rule(-16, new int[]{6,-2,27,-6});
    rules[30] = new Rule(-10, new int[]{12,18,-2,19});
    rules[31] = new Rule(-19, new int[]{});
    rules[32] = new Rule(-12, new int[]{13,-19,-13});
    rules[33] = new Rule(-13, new int[]{-3});
    rules[34] = new Rule(-13, new int[]{-13,20,-3});
    rules[35] = new Rule(-15, new int[]{25,-17,26,-2});
    rules[36] = new Rule(-16, new int[]{6,-2,27,-6});
    rules[37] = new Rule(-14, new int[]{22,-2,23,-6});
    rules[38] = new Rule(-14, new int[]{22,-2,23,-6,24,-6});
  }
...
{ CurrentSemanticValue.stVal = new WhileNode(ValueStack[ValueStack.Depth-3].eVal, ValueStack[ValueStack.Depth-1].stVal); }
        break;
      case 30: // write -> WRITE, LPAREN, expr, RPAREN
...
{ 
        ...
        break;
      case 34: // varlist -> varlist, COLUMN, ident
{ 
        ...
        break;
      case 35: // repeat -> REPEAT, stlist, UNTIL, expr
...
{ CurrentSemanticValue.stVal = new WhileNode(ValueStack[ValueStack.Depth-3].eVal, ValueStack[ValueStack.Depth-1].stVal); }
        break;
      case 37: // if -> IF, expr, THEN, statement
