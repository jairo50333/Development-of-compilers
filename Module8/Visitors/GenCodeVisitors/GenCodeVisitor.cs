...
namespace SimpleLang.Visitors
{
    public class GenCodeVisitor : Visitor
    {
        ...
        public override void VisitWhileNode(WhileNode while_node)
        {
            Label startWhileLoop = genc.DefineLabel();
            Label endWhileLoop = genc.DefineLabel();

            genc.MarkLabel(startWhileLoop);
            while_node.Expr.Visit(this);
            genc.Emit(OpCodes.Brfalse, endWhileLoop);
            while_node.Stat.Visit(this);
            genc.Emit(OpCodes.Br, startWhileLoop);
            genc.MarkLabel(endWhileLoop);
        }
